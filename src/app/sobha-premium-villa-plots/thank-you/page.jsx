...
const ThankYouContent = () => {
  // Default State (Fallback if accessed directly)
  // You can hardcode this per page, or leave generic
  const [data, setData] = useState({
    projectName: "Sobha Premium Mysore Plots", // Defaulting to the specific page project
    fileLink: "",
    isBrochure: false,
    hasOpened: false,
  });
  ...
  useEffect(() => {
    ...
    if (storedData) {
      ...
      setData((prev) => ({
        ...prev,
        projectName: parsed.projectName || "Sobha Project",
        fileLink: parsed.file || "",
        isBrochure: parsed.type === "brochure",
        hasOpened: false,
      }));

      // Clear storage so it doesn't trigger again on reload
  ...
  return (
    <>
      <div className="min-h-screen bg-slate-50 font-sans selection:bg-[#C5A059] selection:text-white pt-20">
        {/* --- HERO SECTION --- */}
        <div className="relative w-full min-h-[50vh] md:h-[60vh] flex items-center justify-center pb-10">
          {/* Background Image */}
          <div className="absolute inset-0 overflow-hidden">
            <Image
              src="https://res.cloudinary.com/dkoljvhc9/image/upload/f_auto/v1775664046/hero_1_urnb1g.jpg"
              alt="Sobha Premium Mysore Plots Thank You Background"
              fill
            ...
            <div className="p-6 md:p-10">
              <div className="space-y-10 md:space-y-0 md:flex md:justify-between relative">
                ...
                <div className="relative z-10 flex flex-col items-center text-center md:w-1/3">
                  ...
                  <h3 className="font-bold text-slate-900 text-base md:text-lg">
                    {data.isBrochure ? "Brochure Viewed" : "Get in Touch"}
                  </h3>
                  <p className="text-sm text-slate-500 mt-1 max-w-[200px] mx-auto">
                    {data.isBrochure
